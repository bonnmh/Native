...
const LazyLoadingImage = ({
    ...
    if (typeof contentContainerStyle === 'object' && contentContainerStyle != null) {
    ...
    return (
        ...
        >
            <AnimatedFastImage
                ...
                resizeMode={imageResizeMode ? imageResizeMode : FastImage.resizeMode.cover}
                style={{
            ...
            {imageLoading ? (
                <Animated.View style={StyleSheet.flatten([
                    ...
                    loadingImageStyle,
                    {
                        backgroundColor: loadingBackgroundColor ? loadingBackgroundColor : '#f2f2f2',
                        opacity: opacityHide
                    }
                ])}>
                    <ActivityIndicator
