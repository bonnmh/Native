...
import { createStackNavigator, StackCardStyleInterpolator, TransitionSpecs } from '@react-navigation/stack';
...
export const MainScreen = () => (
  <Main.Navigator
    ...
    <Main.Screen name={APP_SCREEN.CAMERA_ROLL} component={CameraRoll}
