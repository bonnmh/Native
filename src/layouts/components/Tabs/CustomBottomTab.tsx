...
const TAB_ICONS: tabProps = {
  [APP_SCREEN.DISCOVER_TAB]: {
    icon: 'tab_home',
    labelKey: 'main:discoverTab:tvTabLabel',
  },
  [APP_SCREEN.SEARCH_TAB]: {
    icon: 'tab_search',
    labelKey: 'main:searchTab:tvTabLabel',
  },
  [APP_SCREEN.POST]: {icon: 'tab_post', labelKey: 'main:postTab:tvTabLabel'},
  [APP_SCREEN.CHAT_TAB]: {
    icon: 'tab_chat',
    labelKey: 'main:chatTab:tvTabLabel',
  },
  [APP_SCREEN.PROFILE_TAB]: {
    icon: 'tab_profile',
    labelKey: 'main:profileTab:tvTabLabel',
  },
};
